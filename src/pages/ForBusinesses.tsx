  ...
  return (
    <div>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-5xl mx-auto px-5">
          <span className="inline-block font-mono text-xs font-semibold tracking-wider uppercase border-2 border-billboard-red text-billboard-red px-3 py-1.5 rounded mb-3">{t("howItWorks.badge")}</span>
          <h2 className="text-3xl md:text-4xl mb-10 max-w-xl">{t("howItWorks.title")}</h2>
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-5">
            {steps.map((s, i) => (
              <div key={STEP_NUMBERS[i]} className="border-[3px] border-billboard-ink rounded p-5 bg-white transition hover:-translate-y-1 hover:shadow-blockSm">
                <div className="font-display text-2xl text-billboard-yellowDeep mb-2" style={{ WebkitTextStroke: "1.5px #1A1712" }}>{STEP_NUMBERS[i]}</div>
      ...
      <section className="py-16 bg-billboard-paperDim border-y-[3px] border-billboard-ink">
        <div className="max-w-5xl mx-auto px-5">
          <span className="inline-block font-mono text-xs font-semibold tracking-wider uppercase border-2 border-billboard-red text-billboard-red px-3 py-1.5 rounded mb-3">{t("channels.badge")}</span>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-4xl mx-auto px-5">
          <span className="inline-block font-mono text-xs font-semibold tracking-wider uppercase border-2 border-billboard-red text-billboard-red px-3 py-1.5 rounded mb-3">{t("comparison.badge")}</span>
          ...
          <div className="border-[3px] border-billboard-ink rounded-lg overflow-hidden">
            <div className="grid grid-cols-2">
              <div className="bg-billboard-green text-white font-display text-sm md:text-base px-4 py-3 text-center">{t("comparison.colUs")}</div>
              <div className="bg-billboard-inkSoft text-white font-display text-sm md:text-base px-4 py-3 text-center border-l-[3px] border-billboard-ink">{t("comparison.colThem")}</div>
            </div>
            {comparisonRows.map((row, i) => (
              <div key={i} className={`grid grid-cols-2 ${i !== comparisonRows.length - 1 ? "border-b-2 border-billboard-ink/15" : ""}`}>
      ...
      <section className="py-16 bg-billboard-green border-t-[3px] border-billboard-ink text-center">
        <div className="max-w-2xl mx-auto px-5">
          <h2 className="font-display text-2xl md:text-3xl text-white mb-4">{t("finalCta.title")}</h2>
